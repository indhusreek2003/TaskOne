                                ...
                                <ul>
                                            ...
                                            <a href="/approved" class="nav-link">
                                                ...
                                                <span class="menu-title">Approved Jobs</span>
                                                                                                                ...
                                                                                                                <li class="sidebar-menu-item  ">
                                            <a href="/expired" class="nav-link">
                                                <i class="menu-icon las la-dot-circle"></i>
                                                <span class="menu-title">Expired Jobs</span>
                                                                                                                                            </a>
                                        </li>
                                                                                                                <li class="sidebar-menu-item  ">
                                            <a href="/reject" class="nav-link">
                                                <i class="menu-icon las la-dot-circle"></i>
                                ...
                                <ul>
                                            ...
                                            <a href="/banned" class="nav-link">
                                                ...
                                                <span class="menu-title">Banned Users</span>
                                                                                                                ...
                                                                                                                <li class="sidebar-menu-item  ">
                                            <a href="/email-unverified" class="nav-link">
                                                <i class="menu-icon las la-dot-circle"></i>
                                                <span class="menu-title">Email Unverified</span>
                                                                                                                                            </a>
                                        </li>
                                                                                                                <li class="sidebar-menu-item  ">
                                            <a href="/mobile-unverified" class="nav-link">
                                                <i class="menu-icon las la-dot-circle"></i>
                                            ...
                                            <a href="/users" class="nav-link">
                                                ...
                                                <span class="menu-title">All Users</span>
                                                                                                                ...
                                                                                                                <li class="sidebar-menu-item  ">
                                            <a href="/send-notification" class="nav-link">
                                                <i class="menu-icon las la-dot-circle"></i>
                                ...
                                <ul>
                                            ...
                                            <a href="/mobile-unverified" class="nav-link">
                                                ...
                                                <span class="menu-title">Mobile Unverified</span>
                                                                                                                ...
                                                                                                                <li class="sidebar-menu-item  ">
                                            <a href="/with-balance" class="nav-link">
                                                <i class="menu-icon las la-dot-circle"></i>
                    ...
                    <div class="table-responsive--md  table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                            ...
                                            <div class="user">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/userdp.png"
                                                        alt="Forgeflex" class="plugin_bg">
                                                </div>
                                                <span class="name">
                                                    <span class="fw-bold d-block">Forgeflex</span>
                                                    <span class="text--small">
                                                        <a href="https://script.viserlab.com/joblab/admin/employers/detail/367">
                                                            <span>@</span>arhamshahzad
                                                        </a>
                                                    </span>
                                                </span>
                                            </div>
                                        ...
                                        <td>
                                            <span class="d-block">2025-09-24 08:53 AM</span>
                                            ...
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/employers/detail/367"
                                                    ...
                                                    <i class="las la-desktop"></i>Details                                                </a>
                                                        ...
                                                        data-action="https://script.viserlab.com/joblab/admin/employers/featured/367"
                                        ...
                                        <td>
                                            <div class="user">
                                                ...
                                                <span class="name">
                                                    <span class="fw-bold d-block"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="97e5f8e5f6fff6a1a1a1a6d7f4f2e5e3e1f2b9f4f8fa">[email&#160;protected]</a></span>
                                                    <span class="text--small">
        ...
        <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
            <div>
                <p class="small text-muted">
                    ...
                    of
                    <span class="fw-semibold">352</span>
                    results
                </p>
            </div>
