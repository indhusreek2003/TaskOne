...
<body>
    ...
    <div class="sidebar__inner">
        ...
        </div>    <div class="sidebar__menu-wrapper">
            <ul class="sidebar__menu">
                                                                                                        <li class="sidebar-menu-item active">
                            <a href = "/dashboard" class="nav-link ">
                                
                                <span class="menu-title"><i class="bi bi-house-door"></i>Dashboard</span>
                                                                                            </a>
                        </li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="sJdlJdby2boAc7rOxqBuJACpA7aebTNEPOQBSh7w" autocomplete="off">                    <div class="modal-body">
                        <div class="row">
