...
<head>
    ...
    <title>JobLab - Manage City</title>
...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Manage City</h6>
    <div class="d-flex flex-wrap justify-content-end gap-2 align-items-center breadcrumb-plugins">
            <form class="d-flex flex-wrap gap-2">
            <div class="input-group w-auto flex-fill">
    <input type="search" name="search" class="form-control bg--white" placeholder="Search city" value="">
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":100,"name":"Cape Town"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this city?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/city/status/100">
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":89,"name":"Dubai"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this city?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/city/status/89">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":78,"name":"Sydney"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this city?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/city/status/78">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":67,"name":"Mumbai"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this city?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/city/status/67">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":56,"name":"Toronto"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this city?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/city/status/56">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":45,"name":"London"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this city?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/city/status/45">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":34,"name":"Houston"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this city?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/city/status/34">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":23,"name":"Chicago"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this city?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/city/status/23">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":12,"name":"Los Angeles"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this city?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/city/status/12">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":1,"name":"New York"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this city?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/city/status/1">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
...
<script>
    ...
    <script>
        ...
        (function($) {
            let modal = $("#my-modal");
            let action = `https://script.viserlab.com/joblab/admin/location/city/save`

            $('.add-btn').on('click', function(e) {
                modal.find('.modal-title').text("New City");
            ...
            $('.edit-btn').on('click', function(e) {
                let action = `https://script.viserlab.com/joblab/admin/location/city/save/:id`;
